...
# Default template contents to ensure compatibility regardless of installation mode

DEFAULT_AGENT_RULES = """# Google Workspace MCP — Agent Behavior Rules
